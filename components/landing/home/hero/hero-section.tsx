          ...
          <div ref={ref} className='flex flex-col gap-8'>
            ...
            >
              ...
              <p className='max-w-2xl text-dark_black/60 dark:text-white/60'>
                LeaveFlow helps teams simplify employee leave requests,
                approvals, and tracking—all in one place. Eliminate manual
                spreadsheets, reduce HR overhead, and give your employees a
                seamless way to manage time off with full transparency and
                efficiency.
              </p>
            </motion.div>
